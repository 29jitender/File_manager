...
implements Comparable<FileObject> {
	...
	@Override
	public int compareTo(FileObject other)// compering dir and files if dir it
											// should come on top otherwish sort
											// files
	{
	...
	public static String bytecount_format(long bytes, boolean si) { // getting
																	// size of
																	// file in
																	// redable
																	// format
